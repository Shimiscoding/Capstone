...
<body class="auth-page login-page">
    <main class="auth-shell">
        <section class="auth-card">
            ...
            <p class="auth-description">Enter the six-digit code sent to <strong>{{ auth()->user()->email }}</strong>. It expires in 10 minutes.</p>
            ...
            <form method="POST" action="{{ route('verification.verify') }}" class="auth-form">
                ...
                <div>
                    ...
                    <input id="otp" name="otp" type="text" inputmode="numeric" pattern="[0-9]{6}" maxlength="6" autocomplete="one-time-code" required autofocus class="auth-input auth-otp-input">
