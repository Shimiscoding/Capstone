    ...
    <aside class="sidebar" aria-label="Main navigation">
      <div class="sidebar-scroll">
        ...
        <nav class="nav-section">
          ...
          <button class="nav-item" href="{{ route('dashboard.impounding') }}">
      ...
      <section class="workspace">
        <div class="page-head users-page-head">
          ...
          <div class="users-page-actions">
            ...
            <a class="add-user-button" href="{{ route('dashboard.users.create') }}">+ Add user</a>
          </div>
        </div>
              ...
              <tbody>
                @forelse ($users as $listedUser)
                  ...
                  <tr>
                    ...
                    <td><span class="role-badge role-{{ $listedUser->role }}">{{ ucfirst($listedUser->role) }}</span></td>
                    <td>{{ $listedUser->created_at?->format('M d, Y') ?? '—' }}</td>
                    <td><span class="status-badge"><i></i> Registered</span></td>
                    <td>
                      <div class="user-row-actions" aria-label="Actions for {{ $listedName }}">
                        <button class="user-action action-edit" type="button">Edit</button>
                        <button class="user-action action-update" type="button">Update</button>
                        <button class="user-action action-delete" type="button">Delete</button>
                      </div>
                    </td>
                  </tr>
                @empty
